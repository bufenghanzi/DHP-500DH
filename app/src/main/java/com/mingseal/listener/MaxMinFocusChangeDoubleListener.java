 ...
 *
 */
public class MaxMinFocusChangeDoubleListener implements OnFocusChangeListener {
	 ...
	 *            当前Edittext控件
	 */
	public MaxMinFocusChangeDoubleListener(Double maxValue, Double minValue, EditText etNumber) {
		super();
	...
	public void onFocusChange(View v, boolean hasFocus) {
		if (!hasFocus) {
			...
			try {
				value = Double.parseDouble(etNumber.getText().toString());
